...
/// @custom:security-contact macim.kabal@yandex.ru
contract VoenmemCoin is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20FlashMint {
    constructor(address initialOwner)
        ERC20("Voenmem Coin", "VMC")
        Ownable(initialOwner)
        ERC20Permit("Voenmem Coin")
    {
